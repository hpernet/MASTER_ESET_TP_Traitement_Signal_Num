...
% %TF du signal Radar Emis
% %%TF_ImpRadarEM = ; % A completer
% 
% % Module et Phase de la TF du signal Radar Emis
% %%Md_TF_ImpRadarEM  = ; % A completer
% %%Ph_TF_ImpRadarEM  = ; % A completer
% 
% % TF du signal EchoRadar3
% TF_EchoRadar3 = ; % A completer
% 
% % Module et Phase de la TF du signal EchoRadar2
% Md_TF_EchoRadar3  = ; % A completer
% Ph_TF_EchoRadar3  = ; % A completer
% 
% figure(314);
% % A completer
% 
...
%********* Question 3.2.a  ****************************************************************%
% % Correlations
% %AutoCorr_ImpRadarEM = xcorr(......,......); % A completer
% InterCorr_ImpRadarEM_EchoRadar3 = ;   % A completer
% 
% % Nonbre de points des correlations
% %NbPt_AutoCorr = ; % A completer
% NbPt_InterCorr3 = ; % A completer
