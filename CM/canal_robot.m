...
t=[0:resolution:tmax];
N=length(t);
delai_1=1/K*exp(d_1_ln)/3e8;   % s 
if delai_1>tmax error('Le robot est trop éloigné pour détecter!'); end; 
att_propag_dB_1=147.6-20*log10(1/K*exp(d_1_ln))-20*log10(fc);
%
canal_1=zeros(1,N);
...
delai_2=1/K*exp(d_2_ln)/3e8;   % s 
if delai_2>tmax error('Le robot est trop éloigné pour détecter!'); end; 
att_propag_dB_2=147.6-20*log10(1/K*exp(d_2_ln))-20*log10(fc);
%
canal_2=zeros(1,N);
